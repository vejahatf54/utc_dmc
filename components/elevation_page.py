...
# This functionality is handled by update_results_grid callback (line 2190)
...
def update_results_grid(load_clicks, unit_data, line_value, current_rows, full_store_rows, dd_dist_unit, dd_elev_unit):
    try:
        ...
        if df.empty:
            unit_data_out = {'distance': dd_dist_unit or 'mi', 'elevation': dd_elev_unit or 'ft'} if trig == 'load-line-btn' else dash.no_update
