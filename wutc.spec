...
datas = [
    ...
    # Include clean architecture components
...
try:
    ...
    print(f"Added {len(dmc_data)} DMC Mantine data files")
except ImportError:
    # Fallback method for DMC Mantine
    try:
        import dash_mantine_components as dmc
        dmc_path = os.path.dirname(dmc.__file__)
        # Add the entire DMC Mantine package assets
...
hiddenimports = [
    ...
    'components.password_change_page',
    ...
    'domain.archive_models',
    'domain.csv_rtu_models',
    'domain.fluid_models',
    'domain.review_models',
    'domain.rtu_models',
    'domain.time_models',
    ...
    'controllers.rtu_to_csv_controller',
    'controllers.sps_time_controller',
